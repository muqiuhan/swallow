...
TEST_CASE(
  "structopt can parse enum class positional argument" * test_suite("enum_positional"))
{
  {
...
TEST_CASE(
  "structopt can parse enum array positional argument" * test_suite("enum_positional"))
{
  {
...
TEST_CASE(
  "structopt can parse enum vector positional argument" * test_suite("enum_positional"))
{
  {
...
TEST_CASE(
  "structopt can parse enum pair positional argument" * test_suite("enum_positional"))
{
  {
