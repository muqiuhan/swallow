...
/**
 ** \file /home/muqiuhan/Workspace/swallow/compiler/parser/include/bison_parser.hpp
...
#ifndef YY_YY_HOME_MUQIUHAN_WORKSPACE_SWALLOW_COMPILER_PARSER_INCLUDE_BISON_PARSER_HPP_INCLUDED
# define YY_YY_HOME_MUQIUHAN_WORKSPACE_SWALLOW_COMPILER_PARSER_INCLUDE_BISON_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 12 "/home/muqiuhan/Workspace/swallow/compiler/parser/parser.y"

    #include "../../ast/include/ast.hpp"
    using namespace swallow::ast;

#line 54 "/home/muqiuhan/Workspace/swallow/compiler/parser/include/bison_parser.hpp"
...
namespace yy {
#line 189 "/home/muqiuhan/Workspace/swallow/compiler/parser/include/bison_parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
        ...
        switch (this->kind ())
    {
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<Branch::Ptr>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<Constructor::Ptr>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<Constructor::Ptr>& v)
        : Base (t)
        , value (v)
      {}
#endif
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<Definition::Ptr>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_OCURLY ()
      {
        return symbol_type (token::OCURLY);
      }
#else
      static
      symbol_type
      ...
      make_CCURLY ()
      {
        return symbol_type (token::CCURLY);
      }
#else
      static
      symbol_type
      ...
      make_OBRACKET ()
      {
        return symbol_type (token::OBRACKET);
      }
#else
      static
      symbol_type
      ...
      make_CBRACKET ()
      {
        return symbol_type (token::CBRACKET);
      }
#else
      static
      symbol_type
      ...
      make_VERTIAL ()
      {
        return symbol_type (token::VERTIAL);
      }
#else
      static
      symbol_type
...
#line 1979 "/home/muqiuhan/Workspace/swallow/compiler/parser/include/bison_parser.hpp"




#endif // !YY_YY_HOME_MUQIUHAN_WORKSPACE_SWALLOW_COMPILER_PARSER_INCLUDE_BISON_PARSER_HPP_INCLUDED
