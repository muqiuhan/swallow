...
let rec build_ast sexpr =
  ...
  | Fixnum _ | Boolean _ | Quote _ | String _ | Record _ | Nil -> literal_expr sexpr
  | Symbol s -> symbol_expr s
  | Pair _ when Object.is_list sexpr ->
    (match Object.pair_to_list sexpr with
    | [ Symbol "if"; cond; if_true; if_false ] -> if_expr cond if_true if_false
    ...
    | [ Symbol "lambda"; args; body ] when Object.is_list args -> lambda_expr args body
    | [ Symbol "apply"; fn_expr; args ] -> apply_expr fn_expr args
    | [ Symbol "defun"; Symbol fn_name; args; body ] -> defun_expr fn_name args body
