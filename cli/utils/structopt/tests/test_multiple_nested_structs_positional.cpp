...
TEST_CASE(
  "structopt can parse multiple nested struct arguments" * test_suite("nested_struct"))
{
  {
...
TEST_CASE(
  "structopt can parse multiple nested struct arguments - Git example"
...
{
  {
    ...
    REQUIRE(
      arguments.config.name_value_pair
