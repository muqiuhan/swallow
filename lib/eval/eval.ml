...
let rec eval_expr expr env =
    let rec eval = function
        ...
        | Object.And (cond_x, cond_y) -> (
            ...
            | _ ->
                raise
                  (Errors.Parse_error_exn (Errors.Type_error "(and bool bool)"))
            )
        ...
        | Object.Lambda (name, args, body) ->
            Object.Closure (name, args, body, env)
        ...
        | Object.Let (Object.LETSTAR, bindings, body) ->
            let eval_binding acc (n, e) =
                Object.bind (n, eval_expr e acc, acc)
            in
        ...
        | Object.Let (Object.LETREC, bindings, body) ->
            ...
            let env' =
                Object.bind_local_list names
                  (List.map Object.make_local values)
                  env
            in
            let updates =
            ...
            | _ ->
                raise
                  (Errors.Parse_error_exn
                     (Errors.Type_error "Expecting closure."))
        in
