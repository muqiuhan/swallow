...
/**
 ** \file /home/muqiuhan/Workspace/swallow/src/parser/include/bison_parser.hpp
...
#ifndef YY_YY_HOME_MUQIUHAN_WORKSPACE_SWALLOW_SRC_PARSER_INCLUDE_BISON_PARSER_HPP_INCLUDED
#define YY_YY_HOME_MUQIUHAN_WORKSPACE_SWALLOW_SRC_PARSER_INCLUDE_BISON_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 12 "/home/muqiuhan/Workspace/swallow/src/parser/parser.y"

#include "../../ast/include/ast.hpp"
using namespace swallow::ast;

#line 54 "/home/muqiuhan/Workspace/swallow/src/parser/include/bison_parser.hpp"
...
namespace yy {
#line 189 "/home/muqiuhan/Workspace/swallow/src/parser/include/bison_parser.hpp"
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol(typename Base::kind_type t, AST::Ptr &&v)
          : Base(t), value(std::move(v)) {}
#else
      basic_symbol(typename Base::kind_type t, const AST::Ptr &v)
          : Base(t), value(v) {}
#endif

#if 201103L <= YY_CPLUSPLUS
      basic_symbol(typename Base::kind_type t, Branch::Ptr &&v)
          : Base(t), value(std::move(v)) {}
#else
      basic_symbol(typename Base::kind_type t, const Branch::Ptr &v)
          : Base(t), value(v) {}
#endif

#if 201103L <= YY_CPLUSPLUS
      basic_symbol(typename Base::kind_type t, Constructor::Ptr &&v)
          : Base(t), value(std::move(v)) {}
#else
      basic_symbol(typename Base::kind_type t, const Constructor::Ptr &v)
          : Base(t), value(v) {}
#endif

#if 201103L <= YY_CPLUSPLUS
      basic_symbol(typename Base::kind_type t, Definition::Ptr &&v)
          : Base(t), value(std::move(v)) {}
#else
      basic_symbol(typename Base::kind_type t, const Definition::Ptr &v)
          : Base(t), value(v) {}
#endif

#if 201103L <= YY_CPLUSPLUS
      basic_symbol(typename Base::kind_type t, Pattern::Ptr &&v)
          : Base(t), value(std::move(v)) {}
#else
      basic_symbol(typename Base::kind_type t, const Pattern::Ptr &v)
          : Base(t), value(v) {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol(typename Base::kind_type t, std::vector<Branch::Ptr> &&v)
          : Base(t), value(std::move(v)) {}
#else
      basic_symbol(typename Base::kind_type t,
                   const std::vector<Branch::Ptr> &v)
          : Base(t), value(v) {}
#endif
...
#else
      basic_symbol(typename Base::kind_type t,
                   const std::vector<Constructor::Ptr> &v)
          : Base(t), value(v) {}
#endif

#if 201103L <= YY_CPLUSPLUS
      basic_symbol(typename Base::kind_type t, std::vector<Definition::Ptr> &&v)
          : Base(t), value(std::move(v)) {}
#else
      basic_symbol(typename Base::kind_type t,
                   const std::vector<Definition::Ptr> &v)
          : Base(t), value(v) {}
#endif
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_TIMES() { return symbol_type(token::TIMES); }
#else
    static symbol_type make_TIMES() { return symbol_type(token::TIMES); }
#endif
#if 201103L <= YY_CPLUSPLUS
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_DIVIDE() { return symbol_type(token::DIVIDE); }
#else
    static symbol_type make_DIVIDE() { return symbol_type(token::DIVIDE); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_INT(int v) {
      return symbol_type(token::INT, std::move(v));
    }
#else
    static symbol_type make_INT(const int &v) {
      return symbol_type(token::INT, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_FN() { return symbol_type(token::FN); }
#else
    static symbol_type make_FN() { return symbol_type(token::FN); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_DATA() { return symbol_type(token::DATA); }
#else
    static symbol_type make_DATA() { return symbol_type(token::DATA); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_MATCH() { return symbol_type(token::MATCH); }
#else
    static symbol_type make_MATCH() { return symbol_type(token::MATCH); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_WITH() { return symbol_type(token::WITH); }
#else
    static symbol_type make_WITH() { return symbol_type(token::WITH); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_OCURLY() { return symbol_type(token::OCURLY); }
#else
    static symbol_type make_OCURLY() { return symbol_type(token::OCURLY); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_CCURLY() { return symbol_type(token::CCURLY); }
#else
    static symbol_type make_CCURLY() { return symbol_type(token::CCURLY); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_OPAREN() { return symbol_type(token::OPAREN); }
#else
    static symbol_type make_OPAREN() { return symbol_type(token::OPAREN); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_CPAREN() { return symbol_type(token::CPAREN); }
#else
    static symbol_type make_CPAREN() { return symbol_type(token::CPAREN); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_OBRACKET() { return symbol_type(token::OBRACKET); }
#else
    static symbol_type make_OBRACKET() { return symbol_type(token::OBRACKET); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_CBRACKET() { return symbol_type(token::CBRACKET); }
#else
    static symbol_type make_CBRACKET() { return symbol_type(token::CBRACKET); }
#endif
#if 201103L <= YY_CPLUSPLUS
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_ARROW() { return symbol_type(token::ARROW); }
#else
    static symbol_type make_ARROW() { return symbol_type(token::ARROW); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_VERTIAL() { return symbol_type(token::VERTIAL); }
#else
    static symbol_type make_VERTIAL() { return symbol_type(token::VERTIAL); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_DOUBLEARROW() {
      return symbol_type(token::DOUBLEARROW);
    }
#else
    static symbol_type make_DOUBLEARROW() {
      return symbol_type(token::DOUBLEARROW);
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_EQUAL() { return symbol_type(token::EQUAL); }
#else
    static symbol_type make_EQUAL() { return symbol_type(token::EQUAL); }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LID(std::string v) {
      return symbol_type(token::LID, std::move(v));
    }
#else
    static symbol_type make_LID(const std::string &v) {
      return symbol_type(token::LID, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_UID(std::string v) {
      return symbol_type(token::UID, std::move(v));
    }
#else
    static symbol_type make_UID(const std::string &v) {
      return symbol_type(token::UID, v);
    }
#endif
...
#line 1979 "/home/muqiuhan/Workspace/swallow/src/parser/include/bison_parser.hpp"

#endif // !YY_YY_HOME_MUQIUHAN_WORKSPACE_SWALLOW_SRC_PARSER_INCLUDE_BISON_PARSER_HPP_INCLUDED
